...
<script type="text/javascript" language="javascript">
	function shangPage1(){
		...
		$.ajax({
			type:'post',
			url:encodeURI("goodsZr/noint_goodszr_indexSearch.action?keyword="+keyword+"&page=${page-1}"),
	...
	function jump1(){
		...
		$.ajax({
			type:'post',
			url:encodeURI("goodsZr/noint_goodszr_indexSearch.action?keyword="+keyword+"&page="+jumppage),
			beforeSend:function(XMLHttpRequest){
...
<body>
	...
	<div
		...
		<div
			...
			<input id="ddd" style="width: 100px; height: 30px; border: 0px;" />
		</div>
