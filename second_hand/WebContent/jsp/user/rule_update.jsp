...
<script type="text/javascript" language="javascript">
	...
	/* 	if(validTime == ""){
		...
		$.ajax({
			type:'post',
			data:{ruleId:ruleId,ruleValue:ruleValue},
			url:encodeURI('rule/rule_update'),
...
<body>
           ...
           <div style="width:98%; height:300px; margin:0px auto; background-color:#f9f9f9; margin-bottom: 10px;">
           		<table width="100%" style="width:100%;">
                	<tr height="50px">
                	<input id="ruleId" value="${rule.ruleId}" type="hidden"></input>
                    	<td width="280px" align="right">积分项目：</td>
                        <td><input readonly="readonly" value="${rule.ruleName}" id="ruleName" style="border-radius:5px; width:300px; height:30px; padding-left:5px;" /> </td>
                    </tr>
                   <!--  <tr height="50px">
                    	<td width="280px" align="right">加减规则：</td>
                        <td>
                             加：<input name="fuhao" type="radio" checked="checked" value="+"  style="border-radius:5px; width:20px; height:30px; padding-left:5px;" />
             	减：<input name="fuhao" type="radio" value="-" style="border-radius:5px; width:20px; height:30px; padding-left:5px;" />           
                    ...
                    <tr height="50px">
                        ...
                        <td><input value="${rule.ruleValue}" id="ruleValue" style="border-radius:5px; width:300px; height:30px; padding-left:5px;" /> </td>
                    </tr>
                    <tr height="50px">
                    	<td width="280px" align="right">有效时间：</td>
                        <td><input readonly="readonly" value="${rule.validTime}" id="validTime" style="border-radius:5px; width:300px; height:30px; padding-left:5px;" /> </td>
                    </tr>
                  	<tr height="50px">
                    	<td>
                    	</td>
                    	<td>
                    		<button class="mybutton" style="width:100px;" onclick="ruleUpdateSubmit();" >修改</button>
