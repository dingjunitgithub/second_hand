...
<script type="text/javascript" language="javascript">	
	function suggtodelete(id){
		$.ajax({
			type:'get',
			url:encodeURI("suggest/sugg_delete.action?id="+id),
	...
	function shangPage(){
		$.ajax({
			type:'get',
			url:encodeURI("suggest/sugg_toList.action?page=${page-1}"),
			beforeSend:function(XMLHttpRequest){
	...
	function jump(){
		...
		$.ajax({
			type:'get',
			url:encodeURI("suggest/sugg_toList.action?page="+jumppage),
			beforeSend:function(XMLHttpRequest){
...
<body>
           ...
           <div style="width:98%; height:510px; margin:0px auto; background-color:#ffffff;">
           		<table width="100%" border="0">
                    ...
                    <c:forEach items="${suggList}" var="sugg" varStatus="status">
                        ...
                        <td>
	                         <div style="width:20px; height:20px;float:left;cursor: pointer;margin-left:10px;">
	                        	 <img src="index_img/delete_button.png" width="100%" height="100%"  onclick="suggtodelete('${sugg.suggId}');"/>
	                        </div>
                        </td>
                    </tr>
                    <tr>
