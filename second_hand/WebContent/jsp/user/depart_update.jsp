...
function test(){
	...
	function schoolupdateSubmit(){
		...
		$.ajax({
			type:'post',
			data:{departName:name,schoolId:schoolId,departId:id},
			url:encodeURI('depart/depart_update.action'),
...
<body>
			<input id="id" type="hidden" value="${depart.departId}" />
                	...
                	<tr height="50px">
                        ...
                        <td><select name="school.city.cityId" id="city" style="width:300px;border-radius:5px;height:30px;  padding-left:5px; font-size:12px;" onchange="test()">
                            	<c:forEach items="${cityList}" var="city">
                            			...
                            			<c:choose>
                            			<c:when test="${depart.school.city.cityName == city.cityName }">
...
<select name="depart.school.schoolId" id="school" style="width:300px;border-radius:5px;height:30px;  padding-left:5px; font-size:12px;">
                            	<c:forEach items="${schoolList}" var="school">
                            			<c:choose>
                            			<c:when test="${depart.school.schoolName == school.schoolName }">
                   ...
                   <tr height="50px">
                        ...
                        <td><input id="departName" value="${depart.facultyName}" style="border-radius:5px; width:300px; height:30px; padding-left:5px;" /> </td>
                    </tr>
