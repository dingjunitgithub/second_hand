...
<script type="text/javascript" language="javascript">
	...
	function schooltoupdate(id){
		$.ajax({
			type:'get',
			url:encodeURI("city/city_toUpdate.action?cityId="+id),
			beforeSend:function(XMLHttpRequest){
	...
	function schooltodelete(id){
		$.ajax({
			type:'get',
			url:encodeURI("city/city_delete.action?cityId="+id),
			beforeSend:function(XMLHttpRequest){
	...
	function shangPage(){
		$.ajax({
			type:'get',
			url:encodeURI("city/city_toList.action?page=${page-1}"),
			beforeSend:function(XMLHttpRequest){
	...
	function jump(){
		...
		$.ajax({
			type:'get',
			url:encodeURI("city/city_toList.action?page="+jumppage),
			beforeSend:function(XMLHttpRequest){
                    ...
                    <c:forEach items="${cityList}" var="city" varStatus="status">
                        ...
                        <td>
	                        <div style="width:20px; height:20px;float:left; cursor: pointer;margin-left:10px;">
	                        	 <img src="index_img/update_button.png" width="100%" height="100%"  onclick="schooltoupdate('${city.cityId}');"/>
	                        </div>
	                         <div style="width:20px; height:20px;float:left;cursor: pointer;margin-left:10px;">
	                        	 <img src="index_img/delete_button.png" width="100%" height="100%"  onclick="schooltodelete('${city.cityId}');"/>
	                        </div>
                        </td>
	                    </tr>
	                    <tr>
