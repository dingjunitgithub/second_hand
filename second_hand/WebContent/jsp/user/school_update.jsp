...
<script type="text/javascript" language="javascript">
	function schoolupdateSubmit(){
		...
		$.ajax({
			type:'post',
			data:{schoolName:name,cityId:cityId,schoolId:id},
			url:encodeURI('school/school_update.action'),
...
<body>
	<input id="id" type="hidden" value="${school.schoolId }" />
	...
	<div
		...
		<table width="100%" style="width: 100%;">
				...
				<select id="city"
					style="width: 300px; border-radius: 5px; height: 30px; padding-left: 5px; font-size: 12px;">
						<c:forEach items="${cityList}" var="city">
							<c:choose>
                            			<c:when test="${school.city.cityName == city.cityName }">
			...
			<tr height="50px">
				...
				<td><input id="name" value="${school.schoolName }"
			...
			<tr height="50px">
				...
				<td>
					<button class="mybutton" style="width: 100px;"
						onclick="schoolupdateSubmit();">修改</button>
